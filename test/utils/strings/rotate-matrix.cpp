...
25 20 15 10  5
*/
TEST(rotateMatrixBy90Degrees, with_6x6_matrix)
{
    std::vector<std::vector<int>> inputMatrix;
    std::vector<int> firstRowInput = {1, 2, 3, 4, 5, 6};
    std::vector<int> secondRowInput = {7, 8, 9, 10, 11, 12};
    std::vector<int> thirdRowInput = {13, 14, 15, 16, 17, 18};
    std::vector<int> fourthRowInput = {19, 20, 21, 22, 23, 24};
    std::vector<int> fifthRowInput = {25, 26, 27, 28, 29, 30};
