...
namespace utils {
    ...
    namespace tree {
         ...
         */
        template <typename T>
        datastructures::BinarySearchTree<T> minimalTree(datastructures::ArrayList<T> &array) {
            ...
            utils::tree::insertInto<T>(tree, array, 0, arraySize - 1);

            return tree;
        }

        template <typename T>
        void insertInto(datastructures::BinarySearchTree<T>& tree, datastructures::ArrayList<T> &array, const T& min, const T& max) {
        ...
        template <typename T>
        datastructures::BinarySearchTree<T> minimalTreeOptimized(datastructures::ArrayList<T> &array) {
            datastructures::BinarySearchTree<T> tree;
